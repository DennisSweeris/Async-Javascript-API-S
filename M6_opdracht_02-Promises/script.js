/*
Exercise 1:
Write a function testNum that takes a num as an argument and returns a Promise that tests if the value 
...
makeAllCaps(), will take in an array of words and capitalize them, and then the second function, sortWords(),
